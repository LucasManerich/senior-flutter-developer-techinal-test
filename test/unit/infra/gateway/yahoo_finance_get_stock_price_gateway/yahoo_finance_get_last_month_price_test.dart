...
void main() {
  test('Testa o gateway de acesso a API de preços de ações - BCFF11 no último mês por dia', () async {
    final getStockPrice = YahooFinanceGetStockPriceGateway(DioAdapter(), HttpQueryStringAdapter());
    final output = await getStockPrice.perform('BCFF11.SA', granularity: Granularity.day, range: Range.oneMonth);
    expect(output.ticker, 'BCFF11.SA');
